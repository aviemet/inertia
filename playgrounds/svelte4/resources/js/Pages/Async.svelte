...
<TestGrid>
  <TestGridItem class="space-y-4">
    ...
    <button class="px-4 py-2 text-white bg-green-600 rounded" on:click={simulateConflict}>Reload → Visit</button>
  </TestGridItem>
  ...
  <TestGridItem class="space-y-4">
    ...
    <button on:click={triggerVisitThenReload} class="px-4 py-2 text-white bg-green-600 rounded">Visit → Reload</button>
  </TestGridItem>

  <TestGridItem class="space-y-4">
    <p>Simply trigger a 4 second reload so you can navigate or do whatever you'd like during it.</p>
    <button on:click={triggerLongReload} class="px-4 py-2 text-white bg-green-600 rounded">Trigger Long Reload</button>
  </TestGridItem>

  <TestGridItem class="space-y-4">
    <p>Trigger an automatic cancellation from the token.</p>
    <button on:click={triggerCancel} class="px-4 py-2 text-white bg-green-600 rounded">Trigger Cancel</button>
  </TestGridItem>

  <TestGridItem class="space-y-4">
    <p>Trigger an automatic cancellation from the token after finishing request.</p>
    <button on:click={triggerCancelAfterFinish} class="px-4 py-2 text-white bg-green-600 rounded">
